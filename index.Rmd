...
Create a small 5 slide (maximum) presentation and host it on GitHub - place the link in your Quarto portfolio
...
1. Go to the `_quarto.yml` file and make sue that that you have this line of code: `output_dir: docs` (it should be there)
